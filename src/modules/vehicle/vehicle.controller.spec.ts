...
describe('VehicleController', () => {
  ...
  describe('getVehicle', () => {
    it('should return vehicle by valid id', async () => {
      ...
      jest
        ...
        .mockImplementation(async () => vehicle);
  ...
  describe('getDriverVehicles', () => {
    it('should return all vehicles by valid driver id', async () => {
      ...
      jest
        .spyOn(vehicleService, 'getDriverVehicles')
        .mockImplementation(async () => vehicles);

      expect(await vehicleController.getDriverVehicles(+validDriverId)).toBe(
        vehicles,
      );
    });
    ...
    it('should return empty list by invalid driver id', async () => {
      ...
      expect(await vehicleController.getDriverVehicles(+invalidDriverId)).toBe(
        result,
      );
    });
  });
  ...
  describe('getOrderVehicles', () => {
    it('should return a vehicle by valid order id', async () => {
      ...
      jest
        .spyOn(vehicleService, 'getOrderVehicles')
        .mockImplementation(async () => vehicle);

      expect(await vehicleController.getOrderVehicles(validOrderId)).toBe(
        vehicle,
      );
    });
    ...
    it('should return undefined by invalid order id', async () => {
      ...
      expect(await vehicleController.getOrderVehicles(invalidOrderId)).toBe(
        result,
      );
    });
  });
  ...
  describe('createVehicle', () => {
    it('should create vehicle and return its credentials', async () => {
      ...
      expect(await vehicleController.createVehicle(vehicleToCreate)).toBe(
        result,
      );
    });
  });
