...
describe('CargoController', () => {
  ...
  describe('getCargo', () => {
    it('should return a cargo by valid id', async () => {
      ...
      jest
        .spyOn(cargoService, 'getCargo')
        .mockImplementation(async () => resultCargo);
  ...
  describe('getOrderCargos', () => {
    it('should return a list of cargos by valid orderId', async () => {
      ...
      jest
        .spyOn(cargoService, 'getOrderCargos')
        .mockImplementation(async () => resultCargoList);

      expect(await cargoController.getOrderCargos(validOrderId)).toBe(
        resultCargoList,
      );
    });
    ...
    it('should return an empty list by invalid orderId', async () => {
      ...
      expect(await cargoController.getOrderCargos(invalidOrderId)).toBe(
        resultCargoList,
      );
    });
  });
  ...
  describe('createCargo', () => {
    it('should create new cargo and return it as a response', async () => {
      ...
      jest
        .spyOn(cargoService, 'createCargo')
        .mockImplementation(async () => resultCargo);

      expect(await cargoController.createCargo(orderId, inputCargo)).toBe(
        resultCargo,
      );
    });
  });
  ...
  describe('updateCargo', () => {
    it('should update existing cargo and return its id as a response', async () => {
      ...
      jest
        .spyOn(cargoService, 'updateCargo')
        .mockImplementation(async () => result);

      expect(await cargoController.updateCargo(cargoId, updateCargo)).toBe(
        result,
      );
    });
  });
  ...
  describe('deleteCargo', () => {
    it('should delete cargo and return its id as a response', async () => {
      ...
      jest
        .spyOn(cargoService, 'deleteCargo')
        .mockImplementation(async () => result);
