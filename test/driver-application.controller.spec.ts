...
import { DriverApplicationController } from '../src/modules/driver-application/driver-application.controller';
...
describe('DriverApplicationController', () => {
  ...
  beforeEach(async () => {
    ...
    driverApplicationController = moduleRef.get<DriverApplicationController>(DriverApplicationController);
  });
  ...
  describe('getPendingDriverApplications', () => {
    it('should return all driver applications with status "PENDING"', async () => {
      ...
      expect(await driverApplicationController.getPendingDriverApplications()).toBe(driverApplications);
    });
  });
  ...
  describe('createDriverApplication', () => {
    it('should create driver application and return its info', async () => {
      ...
      jest.spyOn(driverApplicationService, 'createDriverApplication').mockImplementation(async () => result);

      expect(await driverApplicationController.createDriverApplication(driverApplication)).toBe(result);
    });
  });
  ...
  describe('approveApplication', () => {
    it('should change "PENDING" status of application to "APPROVED"', async () => {
      ...
      jest.spyOn(driverApplicationService, 'approveApplication').mockImplementation(async () => result);

      expect(await driverApplicationController.approveApplication(id)).toBe(result);
    });
  });
  ...
  describe('declineApplication', () => {
    it('should change "PENDING" status of application to "DECLINED"', async () => {
      ...
      jest.spyOn(driverApplicationService, 'declineApplication').mockImplementation(async () => result);

      expect(await driverApplicationController.declineApplication(id)).toBe(result);
    });
  });
