...
describe('OrderController', () => {
  ...
  beforeEach(async () => {
    const moduleRef = await Test.createTestingModule({
      ...
      providers: [OrderService, LocationService, CargoService, {
  ...
  describe('getPendingOrders', () => {
    it('should return all orders with status PENDING', async () => {
      ...
      jest.spyOn(orderService, 'getPendingOrders').mockImplementation(async () => orders);
  ...
  describe('getApprovedOrders', () => {
    it('should return all orders with status APPROVED', async () => {
      ...
      jest.spyOn(orderService, 'getApprovedOrders').mockImplementation(async () => orders);
  ...
  describe('getUserOrders', () => {
    it('should return all orders by valid user id', async () => {
      ...
      jest.spyOn(orderService, 'getUserOrders').mockImplementation(async () => orders);
    ...
    it('should return empty list by invalid user id', async () => {
      ...
      const result = [];
      jest.spyOn(orderService, 'getUserOrders').mockImplementation(async () => result);
  ...
  describe('getDriverOrders', () => {
    it('should return all orders by valid driver id', async () => {
      ...
      jest.spyOn(orderService, 'getDriverOrders').mockImplementation(async () => orders);

      expect(await orderController.getDriverOrders(validDriverId)).toBe(orders);
    });

    it('should return empty list by invalid driver id', async () => {
      const invalidId = "1000000";
      const result = [];
      jest.spyOn(orderService, 'getDriverOrders').mockImplementation(async () => result);
  ...
  describe('getOrder', () => {
    it('should return order by valid id', async () => {
      ...
      jest.spyOn(orderService, 'getOrder').mockImplementation(async () => order);
    ...
    it('should return undefined by invalid id', async () => {
      ...
      jest.spyOn(orderService, 'getOrder').mockImplementation(async () => result);
  ...
  describe('createOrder', () => {
    it('should create order and return its credentials', async () => {
      ...
      jest.spyOn(orderService, 'createOrder').mockImplementation(async () => result);

      expect(await orderController.createOrder(order)).toBe(result);
    });
  });
  ...
  describe('approveOrder', () => {
    it('should change order status to "APPROVED" and return its id', async () => {
      ...
      jest.spyOn(orderService, 'approveOrder').mockImplementation(async () => result);
  ...
  describe('declineOrder', () => {
    it('should change order status to "DECLINED" and return its id', async () => {
      ...
      jest.spyOn(orderService, 'declineOrder').mockImplementation(async () => result);
  ...
  describe('completeOrder', () => {
    it('should change order status to "COMPLETED" and return its id', async () => {
      ...
      jest.spyOn(orderService, 'completeOrder').mockImplementation(async () => result);
  ...
  describe('updateOrder', () => {
    it('should update order', async () => {
      ...
      jest.spyOn(orderService, 'updateOrder').mockImplementation(async () => result);

      expect(await orderController.updateOrder(id, order)).toBe(result);
    });
  });
